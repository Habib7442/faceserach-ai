...
var Upload = function () {
    ...
    var handleUpgradeClick = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    sonner_1.toast.error('Failed to start checkout process');
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    return (react_1["default"].createElement("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 text-slate-200 py-10 px-4 md:px-8" },
        react_1["default"].createElement("div", { className: "max-w-6xl mx-auto" },
            react_1["default"].createElement("div", { className: "mb-8 flex justify-between items-center bg-slate-800/50 backdrop-blur-sm p-4 rounded-xl border border-slate-700/50" },
                ...
                !(userCredits === null || userCredits === void 0 ? void 0 : userCredits.is_unlimited) && (react_1["default"].createElement(button_1.Button, { onClick: handleUpgradeClick, className: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700" },

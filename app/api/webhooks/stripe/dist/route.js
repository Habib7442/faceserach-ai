...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var body, signature, event, session, _a, userId, planId, creditsToAdd, cookieStore_1, supabase, subscriptionError, _b, currentCredits, fetchError, newTotal, updateError, error_1;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 4:
                    _b = _c.sent(), currentCredits = _b.data, fetchError = _b.error;
                    if (fetchError && fetchError.code !== 'PGRST116') {
                        console.error('Error fetching current credits:', fetchError);
                        throw fetchError;
                    }
                    newTotal = ((currentCredits === null || currentCredits === void 0 ? void 0 : currentCredits.credits_remaining) || 0) + parseInt(creditsToAdd);
                    return [4 /*yield*/, supabase
                            .from('user_credits')
                            .upsert({
                            user_id: userId,

...
function GET(req) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, cookieStore_1, supabase, userCredits, _a, newUserCredits, error, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    cookieStore_1 = headers_1.cookies();
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 1:
                    userCredits = (_b.sent()).data;
                    if (!!userCredits) return [3 /*break*/, 3];
                    return [4 /*yield*/, supabase
                            .from('user_credits')
                            ...
                            .single()];
                case 2:
                    _a = _b.sent(), newUserCredits = _a.data, error = _a.error;
                    if (error)
                        throw error;
                    userCredits = newUserCredits;
                    _b.label = 3;
                case 3: return [2 /*return*/, server_1.NextResponse.json(userCredits)];
                case 4:
                    error_1 = _b.sent();

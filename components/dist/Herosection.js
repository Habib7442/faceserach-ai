...
var Herosection = function () {
    ...
    return (React.createElement("div", { className: "relative w-full h-screen flex justify-center items-center" },
        React.createElement("div", { className: "absolute inset-0" },
            React.createElement(image_1["default"], { src: "/hero.png", alt: "AI Face Search Background", className: "object-cover", fill: true, priority: true, sizes: "100vw" }),
        ...
        React.createElement("div", { className: "relative z-10 text-center space-y-6 px-4 max-w-4xl mx-auto" },
            React.createElement("h1", { className: "text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-200 via-slate-100 to-slate-300 drop-shadow-lg" }, "Welcome to FaceSearch AI"),
            React.createElement("h2", { className: "text-lg md:text-2xl text-transparent bg-clip-text bg-gradient-to-r from-slate-400 via-cyan-300 to-slate-400 font-medium" }, "Experience AI-Powered Face Matching Like Never Before"),
